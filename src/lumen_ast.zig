...
pub const Expr = union(enum) {
    ...
    method_call: struct { obj: *Expr, name: []const u8, args: []*Expr, class_name: ?[]const u8 = null, is_static: bool = false, array_elem_type: ?types.Type = null, array_acc_type: ?types.Type = null, array_result_type: ?types.Type = null, string_method: bool = false, container_type: ?types.Type = null, optional_chain: bool = false, chain_result_type: ?types.Type = null, cb_wants_index: bool = false, number_method: bool = false }, // obj.m(args) / Class.m(args) / Map|Set method
